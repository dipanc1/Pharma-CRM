    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {canManageSales ? (
          ...
          <div className="card">
            <h3 className="text-lg font-medium text-gray-900 mb-2">Sales Items</h3>
            <p className="text-sm text-gray-500">
              Sales entry is disabled for your account.
            </p>
          </div>
        )}
        ...
        {/* Action Buttons */}
        <div className="flex items-center justify-between">
          <SecondaryButton link={`/visits/${formData.id || ''}`}>Cancel</SecondaryButton>
          <button
            type="submit"
            className="btn-primary"
            disabled={saving}
          >
            {saving ? 'Saving...' : 'Update Visit'}
          </button>
        </div>
      </form>
    </div>
